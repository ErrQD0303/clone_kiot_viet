...
class ValueObject:
    ...
    def __composite_values__(self):
        """Return the composite values of the value object. This method is used for saving value objects to the database."""
        return self.value

    # sqlalchemy load this value from database
    @classmethod
    def from_value(cls, value: Any) -> TValueObject:
        """Create a value object from a given value. This method is used for loading value objects from the database."""
